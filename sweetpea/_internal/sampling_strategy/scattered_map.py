...
from sweetpea._internal.sampling_strategy.SMGen import _Factor,_DerivedLevel,_WithinTrial,_Transition,encode_experiment,define_cross,execute,print_factors
		...
		for c in block.constraints:
			if type(c)==AtMostKInARow or type(c)==AtLeastKInARow :
				_cexit("This test version of the module doesn't support AtMost/AtLeast constraints. "
					"Limit your constraints to WithinTrials and Transitions.")
