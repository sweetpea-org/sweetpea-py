...
class IterateGenGurobi(SamplingStrategy):

    @staticmethod
    def class_name():
        return 'IterateGenGurobi'
...
# TODO: Figure out what this line does. Probably will be something like: "GurobiSamplingStrategy = Gurobi"
