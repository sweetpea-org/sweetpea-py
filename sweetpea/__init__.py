...
language. :ref:`The SweetPea language <introduction>` allows for the
specification of randomized experimental designs and the synthesis of trial
sequences from those designs.
"""
