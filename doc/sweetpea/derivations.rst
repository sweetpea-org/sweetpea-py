...
.. function:: sweetpea.primitives.within_trial(predicate, factors)
...
.. function:: sweetpea.primitives.transition(predicate, factors)
...
.. function:: sweetpea.primitives.window(predicate, factors, width, stride)

              Creates a level that is selected denpending on a
              combination of levels from other factors in the current
