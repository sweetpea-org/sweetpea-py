...
from sweetpea import factor, derived_level, within_trial, at_most_k_in_a_row, transition
...
congruency_transition = factor("congruency_transition", [
    ...
    derived_level("ntr-ntr", transition(lambda c: c[0] == "neutral"     and c[1] == "neutral",     [congruency])),
])
